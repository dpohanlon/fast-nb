...
eigenToStdVectorCopy(const Eigen::MatrixBase<Derived> &eigenVec) {
...
stdVectorToEigenCopy(const std::vector<T> &stdVec) {
...
mapStdVectorToEigen(const std::vector<T> &stdVec) {
...
mapStdVectorToEigen(std::vector<T> &stdVec) {
